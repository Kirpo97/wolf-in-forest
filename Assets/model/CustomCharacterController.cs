...
public class CustomCharacterController : MonoBehaviour{ 	
    ...
    public float lernmultiplier = 7f;
    ...
    private void Update()
    {
        horizontal = Mathf.Lerp(horizontal, fixedJoystick.Horizontal, Time.deltaTime*lernmultiplier);
        vertical = Mathf.Lerp(vertical, fixedJoystick.Vertical, Time.deltaTime*lernmultiplier);
    ...
    public void Jump()
    {
       ...
       // rig.velocity = new Vector3(rig.velocity.x, jumpForce);
    }
